...
<div class="column-content">
    ...
    <div class="span-10 row separator">
        ...
        <div class="jq-complete hide">
            <p>Aumente el tr&aacute;fico cualificado hacia su web mediante la <b>optimizaci&oacute;n de la estructura y contenidos</b> de la misma.</p>
    ...
    <div class="span-10 row">
        ...
        <div class="col-2">
            ...
            <div class="jq-complete hide">
                <p>Es una poderosa herramienta de marketing directo que permite la comunicaci&oacute;n con sus clientes actuales o potenciales mediante el env&iacute;o de e-mails. Adem&aacute;s le brinda la posibilidad de determinar y elegir el target de personas ya sea por pa&iacute;s, idioma, etc.</p>
...
<div class="column-content">
    <div class="span-10 row separator">
        ...
        <div class="jq-complete hide">
            <p>Las campa&ntilde;as publicitarias realizadas por Banners se apoyan en todos los medios disponibles. La diversidad de productos al alcance del cliente es muy amplia.</p>
    ...
    <div class="span-10 row separator">
        ...
        <div class="jq-complete hide">
            <p>El e-mail se ha convertido en un medio muy eficaz para la promoci&oacute;n de productos y servicios de una manera r&aacute;pida y econ&oacute;mica, permitiendo alcanzar con el mensaje publicitario a una audiencia calificada y de manera personalizada.</p>
    ...
    <div class="span-10 row">
        ...
        <div class="jq-complete hide">
            <p>Mediante una campa&ntilde;a de marketing viral se busca que la misma llegue a la mayor cantidad de usuarios posibles. Se lo podr&iacute;a asemejar a un servicio de boca a boca virtual</p>
