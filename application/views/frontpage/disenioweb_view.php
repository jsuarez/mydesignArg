...
<div class="column-content">
    <div id="cont1" class="span-10 row separator">
        ...
        <div class="jq-complete hide">
            ...
            <p>Estamos interesados en brindar una soluci&oacute;n para las necesidades de cada cliente. Orientado a nuevos emprendimientos y negocios j&oacute;venes que buscan dar un paso adelante.</p>
        </div>
    ...
    <div id="cont2" class="span-10 row separator">
        ...
        <div class="jq-complete hide">
            ...
            <p>En definitiva, un sitio autoadministrable le permitir&aacute; tener control total de su sitio sin cargo alguno.</p>
        </div>
    ...
    <div id="cont3" class="span-10 row">
        ...
        <div class="jq-complete hide">
            <p>A trav&eacute;s de nuestro sistema <b>Inmobiliario</b> logre una mayor din&aacute;mica en la compra, venta y alquiler de propiedades en Internet.</p>
