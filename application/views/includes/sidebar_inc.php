...
<div id="flipbox-fcontact" class="form-contact textformat">
    ...
    <form id="form-contact" action="<?=site_url('/contact/send/')?>" method="post" enctype="application/x-www-form-urlencoded">
        ...
        <div class="trow-contact">
            ...
            <div class="cont-msgerror"><?php if( $this->session->flashdata('error_consult')!='' ) echo '<div style="position: absolute; left: -170px; top: 254.4px;"><div class="valid-msgleft"></div><div class="valid-msgmiddle"><label for="txtConsult" generated="true" class="valid-error2">'.$this->session->flashdata('error_consult').'</label></div><div class="valid-msgright"></div></div>';?></div>
        </div>
