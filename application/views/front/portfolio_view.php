...
<div id="slider1" class="portfolio-clientes">
    <a href="" class="prev fleft"><img src="public/img/arrow-client-prev.png" alt="Prev" width="13" height="103" /></a>
    <div class="cont">
        <ul class="resetlist">
        <?php
        $n=0;
    ...
    <a href="" class="next fright"><img src="public/img/arrow-client-next.png" alt="Next" width="13" height="103" /></a>
</div>
