        ...
        submitHandler : function(){
            ...
            $.post(form.attr('action'), form.serialize(), function(data){
                ...
                $('#flipbox-fcontact').flip({
                    direction : 'lr',
                    content   : '<div class="fc-message" style="display:block;">'+(data=="true" ? '<p><img width="32" height="32" alt="" src="public/img/icon-success.png" style="position: relative; top: 8px; left: -5px;" /> El formulario se env&iacute;o correctamente. Nos pondremos en contacto a la brevedad.<br /><br />Muchas Gracias</p>' : '<p><img width="32" height="32" alt="" src="public/img/icon-error.png" style="position: relative; top: 8px; left: -5px;" /> El formulario no ha podido ser enviado. Porfavor, intentelo nuevamente mas tarde o envienos un email a <a href="mailto:info@mydesign.com.ar">info@mydesign.com.ar</a>.</p>')+'</div>',
                    color     : 'transparent',
                    onEnd: function(){
